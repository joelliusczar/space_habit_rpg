...
- (void)insertObject:(Reminder *)value inDaily_remindAtIndex:(NSUInteger)idx;
- (void)removeObjectFromDaily_remindAtIndex:(NSUInteger)idx;
- (void)insertDaily_remind:(NSArray<Reminder *> *)value atIndexes:(NSIndexSet *)indexes;
- (void)removeDaily_remindAtIndexes:(NSIndexSet *)indexes;
- (void)replaceObjectInDaily_remindAtIndex:(NSUInteger)idx withObject:(Reminder *)value;
- (void)replaceDaily_remindAtIndexes:(NSIndexSet *)indexes withDaily_remind:(NSArray<Reminder *> *)values;
- (void)addDaily_remindObject:(Reminder *)value;
- (void)removeDaily_remindObject:(Reminder *)value;
- (void)addDaily_remind:(NSOrderedSet<Reminder *> *)values;
- (void)removeDaily_remind:(NSOrderedSet<Reminder *> *)values;

...
//    return [TimeTools isMask24Hours:hourMask];
//}
//
//
//-(NSString *)AMSymbol{
...
//                                    options:0
//                                     locale:self.utilityStore.inUseLocale];
//    return [TimeTools hourMaskForGivenFormat:formatString];
//    
//}
//
//-(instancetype)init:(id<P_UtilityStore>)utilityStore{
//    if(self=[super init]){
//        _utilityStore = utilityStore;
//    }
//    return self;
//}
//
...
//    return [TimeTools hour:hour inGivenFormatMask:self.hourFormatMask];
//}
//
//
//+(NSInteger)hour:(NSInteger)hour inGivenFormatMask:(NSInteger)hourMask{
//    NSAssert(hour<24&&hour>=0,@"Hour is out of range");
//    BOOL isUsing24Hours = [TimeTools isMask24Hours:hourMask];
//    if(isUsing24Hours){

...
//	rateItem.intervalSize = ((NSNumber *)self.activeDaysDict[SH_getIntervalTypeIntervalSizeKey(dailyRate)]).intValue;
//	return rateItem;
//}
//
//
...
//	NSMutableArray<SHItervalItemDict*> *raw = (NSMutableArray*)self.activeDaysDict[SH_getIntervalTypeKey(rateType)];
...
//	}
//	rateItems.intervalSize = ((NSNumber *)self.activeDaysDict[SH_getIntervalTypeIntervalSizeKey(SH_WEEKLY_INTERVAL)]).intValue;
//	return rateItems;
//}
//
//
//-(SHMonthlyYearlyRateItemList*)buildActiveDays:(SHIntervalType)rateType{
//	SHIntervalType baseRateType = SH_extractBaseIntervalType(rateType);
//	NSMutableArray *raw = (NSMutableArray*)self.activeDaysDict[SH_getIntervalTypeKey(rateType)];
...
//	rateItems.intervalSize = ((NSNumber *)self.activeDaysDict[SH_getIntervalTypeIntervalSizeKey(rateType)]).intValue;
//	return rateItems;
//}
//
//

...
Monster* constructEmptyMonster(){
    NSObject<P_CoreData> *dataController = SharedGlobal.dataController;
    return (Monster *)[dataController constructEmptyEntity:Monster.entity];
}

NSString* randomMonsterKey(NSString* zoneKey){
    MonsterInfoDictionary *monInfoDict = SharedGlobal.monsterInfoDictionary;
...
Monster* getCurrentMonster(){
    ...
    NSArray<NSManagedObject *> *results = [SharedGlobal.dataController getItemWithRequest:request predicate:nil sortBy:@[sortByMonsterKey]];

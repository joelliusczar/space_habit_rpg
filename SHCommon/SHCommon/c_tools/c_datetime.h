...
static const int LEAP_CYCLE_DAYS = 1461;
...
int addYearsToTimestamp(long timestamp,long year,TimeAdditionOptions options,long *ans);
int addMonthsToTimestamp(long timestamp,long month,TimeAdditionOptions, long *ans);
int addDaysToTimestamp(long timestamp,long day,TimeAdditionOptions, long *ans);

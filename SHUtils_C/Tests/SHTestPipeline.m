...
static void _cleanupTr(struct _trObj *tr) {
	if(!tr) return;
	free(tr->myword);
	free(tr);
}
...
-(void)testTransformObjThenGroup {
	...
	XCTAssertEqual(SH_iterable_count(array), 17);
	
	ans = SH_iterable_getItemAtIdx(array, 0);
	cmp = strncmp(ans->myword, "14", 25);
	XCTAssertEqual(cmp, 0);
	...
	ans = SH_iterable_getItemAtIdx(array, 2);
	cmp = strncmp(ans->myword, "28", 25);
	XCTAssertEqual(cmp, 0);
	
	ans = SH_iterable_getItemAtIdx(array, 3);
	cmp = strncmp(ans->myword, "12", 25);
	XCTAssertEqual(cmp, 0);
	
	ans = SH_iterable_getItemAtIdx(array, 4);
	cmp = strncmp(ans->myword, "24", 25);
	XCTAssertEqual(cmp, 0);
	
	ans = SH_iterable_getItemAtIdx(array, 5);
	cmp = strncmp(ans->myword, "18", 25);
	XCTAssertEqual(cmp, 0);
	
	ans = SH_iterable_getItemAtIdx(array, 6);
	cmp = strncmp(ans->myword, "46", 25);
	XCTAssertEqual(cmp, 0);
	
	ans = SH_iterable_getItemAtIdx(array, 7);
	cmp = strncmp(ans->myword, "30", 25);
	XCTAssertEqual(cmp, 0);
	
	ans = SH_iterable_getItemAtIdx(array, 8);
	cmp = strncmp(ans->myword, "50", 25);
	XCTAssertEqual(cmp, 0);
	
	ans = SH_iterable_getItemAtIdx(array, 9);
	cmp = strncmp(ans->myword, "62", 25);
	XCTAssertEqual(cmp, 0);
	
	ans = SH_iterable_getItemAtIdx(array, 10);
	cmp = strncmp(ans->myword, "88", 25);
	XCTAssertEqual(cmp, 0);
	
	ans = SH_iterable_getItemAtIdx(array, 11);
	cmp = strncmp(ans->myword, "16", 25);
	XCTAssertEqual(cmp, 0);
	
	ans = SH_iterable_getItemAtIdx(array, 12);
	cmp = strncmp(ans->myword, "22", 25);
	XCTAssertEqual(cmp, 0);
	
	ans = SH_iterable_getItemAtIdx(array, 13);
	cmp = strncmp(ans->myword, "44", 25);
	XCTAssertEqual(cmp, 0);
	
	ans = SH_iterable_getItemAtIdx(array, 14);
	cmp = strncmp(ans->myword, "54", 25);
	XCTAssertEqual(cmp, 0);
	
	ans = SH_iterable_getItemAtIdx(array, 15);
	cmp = strncmp(ans->myword, "96", 25);
	XCTAssertEqual(cmp, 0);
	
	ans = SH_iterable_getItemAtIdx(array, 16);
	cmp = strncmp(ans->myword, "72", 25);
	XCTAssertEqual(cmp, 0);
	
	ans = SH_iterable_getItemAtIdx(array, 17);
	XCTAssertEqual(ans, NULL);
	
	array = SH_pipelineIterator_next(&iter);
	
	XCTAssertEqual(SH_iterable_count(array), 6);
...
-(void)testTransformObjThenGroupThenSkip1Take1 {
	struct _obj nums[25] = {
		{ .val = 7 }, { .val = 5 }, { .val = 14 }, { .val = 6 }, { .val = 12 }, { .val = 9 }, { .val = 65 },
		{ .val = 67 }, { .val = 23 }, { .val = 4 },
		{ .val = 15 }, { .val = 25 }, { .val = 71 }, { .val = 31 }, { .val = 44 }, { .val = 8 }, { .val = 93 },
	...
	struct SHPipelineIterator *iter = SH_pipelineIterator_init(pl5);
	XCTAssertNotEqual(iter, NULL);
	struct SHIterableWrapper *array = SH_pipelineIterator_next(&iter);

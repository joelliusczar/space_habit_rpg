...
-(SHContext *)constructContext:(NSManagedObjectContextConcurrencyType)concurrencyType NS_RETURNS_RETAINED;
...
{
  NSManagedObjectContext* context = [self getPreferedReadContext];
...
-(SHContext*)getPreferedReadContext NS_RETURNS_RETAINED{
  return self.inUseContext?self.inUseContext:self.readContext;
}

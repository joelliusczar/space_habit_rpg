...
extern const int YEAR_MONTHS;
extern const int UNIX_MIN;
extern const int UNIX_HOUR;
extern const int UNIX_DAY;
extern const int UNIX_YEAR;
extern const int UNIX_LEAP_YEAR;
extern const int UNIX_LEAP_YEAR_LAST_SEC;
...
extern const int LEAP_CYCLE_UNIX;
extern const int LEAP_CYCLE_YEAR;
extern const int LEAP_CYCLE_DAYS;
extern const int OFFSET_LEAP_YEAR;
extern const int LEAP_FEB_SUM;
extern const int MIN_SEC_LEN;
extern const int DAY_HOURS;
